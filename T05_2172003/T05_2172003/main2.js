export const gambartitik = (imageDataTemp, x, y, r, g, b) => {
  // Memeriksa apakah x dan y berada dalam batas canvas
  if (x >= 0 && x < imageDataTemp.width && y >= 0 && y < imageDataTemp.height) {
    // Set warna pada piksel yang valid
    var index = (x + y * imageDataTemp.width) * 4;
